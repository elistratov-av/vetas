...
$this->blocks['content-header'] = 'Сотрудники приюта';
?>
<div class="box">
    <div class="box-body">
        <?php echo Html::a(
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $widget) use ($auth) {
                        ...
                        foreach ($model->specialists as $specialist) {
                            if (Yii::$app->user->getIdentity()->specialist->id_organization == $specialist->id_organization && $specialist->organization !== null) {
                                ...
                                $html .= '<a href="' . Url::to(['edit', 'id' => $model->id]) . '" title="Редактировать место работы специалиста">';
