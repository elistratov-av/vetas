...
//        ],
                ...
                [
                    'label' => 'Факт. адрес',
                    'attribute' => 'fact_fias_addresses',
                    'value' => 'owner.fact_fias_addresses.full_address',
                    'filter' => array("1" => "Указан", "2" => "Не указан"),
                ],
                [
                    'label' => 'Рег. адрес',
                    'attribute' => 'fias_addresses',
                    'value' => 'owner.fias_addresses.full_address',
                    'filter' => array("1" => "Указан", "2" => "Не указан"),
                ],
				[
							...
							'audit' => function ($url, $model, $key) {
								...
								return
									Html::a(
										...
										['audit/audit/visit', 'id' => $model->id],
										['class' => 'btn btn-xs btn-info', 'title' => 'История изменения статуса']
									);
							},
						],
				],
