...
$this->blocks['content-header'] = 'Статистика отправки уведомлений по поиску';
...
<div class="box">
        ...
        <form method="get" style="margin-bottom: 20px;">
            ...
            <div class="row">
                <div class="col-md-6" style="padding-right: 0;">
                    <?= Html::a(
                        'Сбросить',
                        Url::toRoute(['statistics/search-events-report']),
                        [
                    ...
                    <?= Html::a(
                        ...
                        Url::toRoute([
                            'statistics/search-events-report/export',
    ...
    <div class="box-body table-responsive">
        <table class="table table-bordered table-hover">
            <tr>
                <th style="width: 30%">Уведомления о публикации нового объявления</th>
                <td>
                    <?= $data['8021.1']['total'] ?? 0 ?>
                </td>
            </tr>
            <tr>
                <th>Уведомления о подписке на рассылку новых объявлений</th>
                <td>
                    <?= $data['8021.2']['total'] ?? 0 ?>
                </td>
            </tr>
            <tr>
                <th>Уведомления об архивации размещенных объявлений</th>
                <td>
                    <?= $data['1075.3']['total'] ?? 0 ?>
                </td>
            </tr>
