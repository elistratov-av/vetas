...
//            если начался новый округ, выводим его название
            ...
            $totalPetsPerArea += $report_row['total_pets'];
            $totalPeriodPetsPerArea += $report_row['period_pets'];
            $totalVisitsPerArea += $report_row['total_visits'];
            $totalPeriodVisitsPerArea += $report_row['period_visits'];

            // ведем общий подсчет
            $totalPets += $report_row['total_pets'];
            $totalPeriodPets += $report_row['period_pets'];
            $totalVisits += $report_row['total_visits'];
            $totalPeriodVisits += $report_row['period_visits'];
        }
    ...
    protected function _renderRow($title, $report_row, $style = FALSE)
    {
        ...
        $sheet->fromArray(
            [
                $title,
                $report_row['total_pets'],
                $report_row['period_pets'],
                $report_row['total_visits'],
                $report_row['period_visits']
            ],
            NULL,
