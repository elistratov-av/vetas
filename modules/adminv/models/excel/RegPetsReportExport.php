 ...
 */
class RegPetsReportExport extends AbstractReportExport
{
     ...
     * @var string
     */
    protected $filename = 'Отчет о выданных регистрационных удостоверениях c {from} по {to}';
    /**
     * @var string
     */
    ...
    protected function renderHead()
    {
        ...
        $str = '<row r="' . $this->currentRow . '" spans="1:8" customHeight="1" ht="50">'
            ...
            . '<c r="G' . $this->currentRow . '" s="3" t="str"><v>Дата регистрации</v></c>'
            . '<c r="H' . $this->currentRow . '" s="3" t="str"><v>Номер регистрационного удостоверения</v></c>'
            . '</row>';
    ...
    private function renderRow($row)
    {
        ...
        $reg_date = $this->cleanupCellValue(ArrayHelper::getValue($row, 'reg_date', ''));
        $number = $this->cleanupCellValue(ArrayHelper::getValue($row, 'number', ''));
        ...
        $str = '<row r="' . $this->currentRow . '" spans="1:8" customHeight="1" ht="30">'
            ...
            . '<c r="G' . $this->currentRow . '" s="9" t="str"><v>' . $reg_date . '</v></c>'
            . '<c r="H' . $this->currentRow . '" s="9" t="str"><v>' . $number . '</v></c>'
            . '</row>';
