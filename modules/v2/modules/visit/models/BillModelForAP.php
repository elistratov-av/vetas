...
class BillModelForAP
{
     ...
     */
    public function __construct($id_visit, $id_discount, $applied_discounts_balance_tmc, $applied_discounts_services, $id_pet = null, $ignore_night_mark_up_ratio = false)
    {
        /*
    ...
    protected function findServices()
    {
        ...
        $this->services = VisitsGovServices::find()
            ...
            ->innerJoin(
                'visit_service_pet',
                'visits_gov_services.id = visit_service_pet.id_visits_gov_service'
            )
            ->where([
                'visit_service_pet.id_pet' => $this->id_pet,
                'id_visit' => $this->id_visit,
