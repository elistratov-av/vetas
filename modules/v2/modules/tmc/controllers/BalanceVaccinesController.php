...
class BalanceVaccinesController extends BaseController
{
    /**
     * @param int $page
     * @param int $limit
    ...
    public function actionList(int $page = 1, int $limit = 10, array $filter = [])
    {
        ...
        return [
            'result' => $balance->getList(TmcBase::TYPE_VACCINE, $page, $limit, $filter)
        ];
    }
    ...
    public function actionAdd($items)
    {
        ...
        $balance->append(TmcBase::TYPE_VACCINE, $items);
