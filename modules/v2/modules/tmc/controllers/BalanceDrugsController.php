...
class BalanceDrugsController extends BaseController
{
    /**
     * @param int $page
     * @param int $limit
    ...
    public function actionList(int $page = 1, int $limit = 10, array $filter = [])
    {
        ...
        return [
            'result' => $balance->getList(TmcBase::TYPE_DRUG, $page, $limit, $filter)
        ];
    }
    ...
    public function actionAdd($items)
    {
        ...
        $balance->append(TmcBase::TYPE_DRUG, $items);
    ...
    /**
     * Редактирование баланса единиц ТМЦ для препаратов
     *
     * @param int $id
     * @param float $count
     * @return bool
    ...
    )
    {
        ...
        if (!$balance = Balance::findOne(['id' => $id, 'type_tmc' => TmcBase::TYPE_DRUG, 'id_specialist' => null])) {
