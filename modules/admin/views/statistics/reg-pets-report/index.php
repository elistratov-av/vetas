...
/** @var \app\modules\admin\models\statistics\RegPetOrganization[] $organizations */
        ...
        <table class="table table-bordered table-hover">
            ...
            <?foreach ($data as $datum): ?>
                ...
                if($currentOrgId != $datum['id_reg_organization']):
                    $currentOrgId = $datum['id_reg_organization']; ?>
                    <tr>
                        <th colspan="8" style="background: #cdcdcd">Организация <?=$orgNames[$currentOrgId] ?? 'не указана' ?></th>
                    </tr>
                <?php endif ?>
                <?php
                if($currentSpecId != $datum['id_species']):
                    ...
                    <tr>
                        <th colspan="8" style="background: #eeeeee"><?= $specNames[$currentSpecId] ?? 'Вид не указан' ?></th>
                    </tr>
                <?php endif ?>
                <tr>
                    <td>
