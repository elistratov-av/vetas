...
/**
 * Class m180929_122524_fix_trigger_to_calc_timeranges
 */
class m180929_122524_fix_trigger_to_calc_timeranges extends Migration
{
    /**
     * {@inheritdoc}
     */
...
set status = vs.status
  ...
  where vs.id = visits.id;');
    ...
    {
        echo "m180929_122524_fix_trigger_to_calc_timeranges cannot be reverted.\n";
