...
/**
 * Class m181002_135906_add_exists_range_function_by_specialist_id
 */
class m181002_135906_add_exists_range_function_by_specialist_id extends Migration
{
    /**
     * {@inheritdoc}
     */
...
SQL;
        $this->execute($sql);
        $this->execute("COMMENT ON FUNCTION 
            public.exists_range(timestamp without time zone, timestamp without time zone, interval, integer) IS 
            'Функциля для определения наличия доступных слотов для пользователя. На входе дата начала и дата окончания периода 
    ...
    {
        echo "m181002_135906_add_exists_range_function_by_specialist_id cannot be reverted.\n";
