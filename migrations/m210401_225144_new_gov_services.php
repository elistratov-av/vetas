...
/**
 * Class m210401_225144_new_gov_services
 */
class m210401_225144_new_gov_services extends Migration
{
    private const SERVICE_0498 = [
        'cod' => '0477',
        'name' => 'Первичный прием узкопрофильного специалиста',
        'alternative_name' => 'Первичный прием узкопрофильного специалиста',
        'price' => 1500,
    ];

    private const SERVICE_0499 = [
        'cod' => '0478',
        'name' => 'Повторный прием узкопрофильного специалиста',
        'alternative_name' => 'Повторный прием узкопрофильного специалиста',
        'price' => 1000,
    ];
