...
/**
 * Class m190426_114320_fix_balance_flow
 */
class m190426_114320_fix_balance_flow extends Migration
{
    /**
     * {@inheritdoc}
     */
 ...
 (SELECT
    (SELECT COALESCE(SUM(count),0)  
     ...
     WHERE id_balance_tmc_type = ' || row_ID || '
       AND balance_tmc_type::text = $3
       AND flow_type = $1) 
  -
    (SELECT COALESCE(SUM(count),0)
     FROM balance_flow
     WHERE id_balance_tmc_type = ' || row_ID || '
       AND balance_tmc_type::text = $4
    ...
    EXECUTE 'UPDATE ' 
            ...
            WHERE id = ' || row_ID || '; '
     USING 
       'income', 'expense', row_TYPE, row_TYPE
     ;
...
SQL;
    ...
    {
        echo "m190426_114320_fix_balance_flow cannot be reverted.\n";
