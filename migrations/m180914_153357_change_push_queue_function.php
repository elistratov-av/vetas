...
/**
 * Class m180914_153357_change_push_queue_function
 */
class m180914_153357_change_push_queue_function extends Migration
{
    /**
     * {@inheritdoc}
     */
...
DECLARE
    job text;
BEGIN
    job := '{"visit_id": ' || visit_id || ', "visit_status": "' || status || '"}'::text;
