...
/**
 * Class m181002_131315_change_exists_range_function
 */
class m181002_131315_change_exists_range_function extends Migration
{
    /**
     * {@inheritdoc}
     */
...
SQL;
        ...
        $this->execute("COMMENT ON FUNCTION 
            public.exists_range(timestamp without time zone, timestamp without time zone, interval) IS 
            'Функциля для определения наличия доступных слотов. На входе дата начала и дата окончания периода 
