...
<div class="title title3">Результат клинического анализа мочи на мочевину</div>
<br>
...
<div>
    <div class="tr2">
        <div class="t32" style="width: 200px;">Мочевина = <?=PdfGenerator::getValue('P26_Mochevinammvalue', $data)?> Ммоль/л</div>
    </div>
</div>
<br>
<br>
