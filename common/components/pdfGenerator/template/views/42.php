...
<div class="title title3">Результат клинического анализа мочи на глюкозу</div>
<br>
...
<div>
    <div class="tr2">
        <div class="t32" style="width: 200px;">Глюкоза = <?=PdfGenerator::getValue('P40_Glukozamcmvalue', $data)?> Ммоль/л</div>
    </div>
</div>
<br>
<br>
