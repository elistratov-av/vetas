...
<div class="title">Результат биохимического исследования крови: - определение прямого билирубина</div>
<div class="title2">экспертиза № <?= PdfGenerator::getValue('P0_Venousbloodanalysisnum', $data) ?></div>
...
<table class="t1" cellpadding="0" cellspacing="0">
    ...
    <tr class="tr">
        <td class="t2">7</td>
        <td class="t2">Билирубин прямой</td>
        <td class="t2">мкмоль/л</td>
        <td class="t2 t22"><?= PdfGenerator::getValue('P18_Conjugatedbilirubinmcmvalue', $data) ?></td>
