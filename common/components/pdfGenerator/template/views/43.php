...
<div class="title title3">Результат общего клинического анализа крови на ретикулоциты</div>
<br>
...
<div>
    <div class="tr2">
        <div class="t32" style="width: 200px;">Ретикулоциты = <?=PdfGenerator::getValue('P100_Reticulocytesvalue', $data)?> Ммоль/л</div>
    </div>
</div>
<br><br>
<div>
