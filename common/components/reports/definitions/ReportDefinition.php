...
class ReportDefinition extends AbstractDefinition
{
    ...
    const PET_HOTEL_STAY_REPORT = 11; // Отчёт о пребывании животных в зоогостинице
    ...
    protected static $titleCollection = [
        ...
        self::PET_HOTEL_STAY_REPORT => 'Отчёт о пребывании животных в зоогостинице',
    ];
