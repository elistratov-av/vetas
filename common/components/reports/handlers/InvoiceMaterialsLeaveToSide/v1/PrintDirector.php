...
use app\common\components\reports\handlers\InvoiceMaterialsLeaveToSide\v1\builders\PrintExcelBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::EXCEL:
                return new PrintExcelBuilder(
                    $this,
                    new FileOptionsXlsDto(['name' => 'make-invoice-leave-to-side_'. date('Ymd_His') . '.xls']),
                    ...$printBuilderConfig
                );
            default:
