...
use app\common\components\reports\handlers\ActVaccineWriteOff\v1\builders\PrintExcelBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::EXCEL:
                return new PrintExcelBuilder(
                    $this,
                    new FileOptionsXlsDto(['name' => 'make-act-vaccine-write-off_' . date('Ymd_His') . '.xls']),
                    ...$printBuilderConfig
                );
            default:
