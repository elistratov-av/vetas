...
use app\common\components\reports\handlers\DailySpendingReport\v1\builders\PrintExcelBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::EXCEL:
                return new PrintExcelBuilder(
                    $this,
                    new FileOptionsXlsDto(['name' => 'make-daily_spending_report_'. date('Ymd_His') . '.xls']),
                    ...$printBuilderConfig
                );
            default:
