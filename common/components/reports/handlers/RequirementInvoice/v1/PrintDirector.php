...
use app\common\components\reports\handlers\RequirementInvoice\v1\builders\PrintExcelBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::EXCEL:
                return new PrintExcelBuilder(
                    $this,
                    new FileOptionsXlsDto(['name' => 'make-requirement-invoice_' . date('Ymd_His') . '.xls']),
                    ...$printBuilderConfig
                );
            default:
