...
/**
 * Событие: Уведомление о необходимости чипирования и вакцинации
 *
 * Class InitialIdentificationAndVaccinationEvent
 * @package app\common\components\inform\events
 */
class InitialIdentificationAndVaccinationEvent extends ElkEvent
{
    const EVENT_CODE = 'initial_info_identification_and_vaccin';
