...
/**
 * This is the model class for table "public.visit_param_values".
 *
 * @property integer $id
 ...
 */
class VisitParamValues extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'public.visit_param_values';
    }
