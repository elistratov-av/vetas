 ...
 *
 * @property PetRefGroundForDisposal $PetRefGroundForDisposal
 * @property Pets $pets
 */
class PetsToPetRefGroundForDisposal extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_ground_for_disposal'], 'exist', 'skipOnError' => true, 'targetClass' => PetRefGroundForDisposal::className(), 'targetAttribute' => ['id_ground_for_disposal' => 'id']],
    ...
    /**
     * Gets query for [[PetRefGroundForDisposal]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getPetRefGroundForDisposal()
    {
        return $this->hasOne(PetRefGroundForDisposal::className(), ['id' => 'id_ground_for_disposal']);
    }
