 ...
 */
class LogUsersBlockManual extends ActiveRecord
{
    const TARGET_FRONTEND = 1;
    const TARGET_ADMIN = 2;

    const TYPE_BLOCK = 1;
    const TYPE_UNBLOCK = 2;
    ...
    {
        return 'audit.log_users_block_manual';
    }
    ...
    {
        return [
            self::TYPE_BLOCK => 'блокировка',
            self::TYPE_UNBLOCK => 'снятие блокировки',
        ];
    }
