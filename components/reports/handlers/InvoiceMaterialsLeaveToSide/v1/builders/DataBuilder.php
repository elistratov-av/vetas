...
use app\common\components\reports\handlers\InvoiceMaterialsLeaveToSide\v1\DataProvider;
use app\common\components\reports\handlers\InvoiceMaterialsLeaveToSide\v1\dto\ReportDto;
use app\common\components\reports\handlers\InvoiceMaterialsLeaveToSide\v1\dto\TmcDto;
    ...
    public function build(string $reportDtoClass)
    {
        ...
        try {
            ...
            $this->reportDto = new $reportDtoClass([
                    ...
                    'initiatorSpecialistName' => $provider->getInitiatorSpecialist(),
                    ...
                    'total_sum'                 => $provider->getTotalSum(),
                ]
            );
