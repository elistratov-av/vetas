...
use app\common\components\reports\handlers\OrganizationReport\v1\builders\PrintExcelBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::EXCEL:
                return new PrintExcelBuilder(
                    $this,
                    new FileOptionsXlsDto(['name' => 'make-organization_report_'. date('Ymd_His') . '.xls']),
                    ...$printBuilderConfig
                );
            default:
