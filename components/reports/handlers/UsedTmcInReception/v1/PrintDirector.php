...
use app\common\components\reports\handlers\UsedTmcInReception\v1\builders\PrintPdfBuilder;
        ...
        switch ($fileType) {
            case FileTypeDefinition::PDF:
                return new PrintPdfBuilder(
                    $this,
                    new FileOptionsPdfDto(['name' => 'used-tmc-in-reception_' . date('Ymd_His') . '.pdf']),
                    ...$printBuilderConfig
                );
            default:
