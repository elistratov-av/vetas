...
use app\common\components\reports\handlers\ActAcceptanceTransfer\v1\dto\MakeSingleRequestDto;
...
class SingleDataProvider extends AbctractDataProvider
{
     ...
     * @return string|null
     */
    public function getFromOrganizationNameHeader(): ?string
    {
        return $this->getFromOrganizationName();
    }
    ...
    {
        return $this->balanceAction->fromSpecialist ? $this->balanceAction->fromSpecialist->getFullnameInitials() : null;
    }

    /**
     * @return string|null
     */
    public function getToOrganizationName(): ?string
    {
        return $this->balanceAction->toOrganization->short_name;
    }

    /**
     * @return string|null
     */
    public function getToSpecialistName(): ?string
    {
        return $this->balanceAction->toSpecialist ? $this->balanceAction->toSpecialist->getFullnameInitials() : null;
    }
